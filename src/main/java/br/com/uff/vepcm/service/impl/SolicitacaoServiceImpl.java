...
import java.util.Objects;
    ...
    public class SolicitacaoServiceImpl implements SolicitacaoService {
        ...
        public Solicitacao alterarSolicitacao(Long id, @Valid Solicitacao solicitacaoAlterado) {
            ...
            if (Objects.nonNull(solicitacaoAlterado.getIdAnoEscolaridade())) solicitacao.setIdAnoEscolaridade(solicitacaoAlterado.getIdAnoEscolaridade());
            if (Objects.nonNull(solicitacaoAlterado.getIdUnidadeEscolar())) solicitacao.setIdUnidadeEscolar(solicitacaoAlterado.getIdUnidadeEscolar());
